...
\begin{figure}[!ht]
	\begin{center}
		\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/sketchfn.png}
	\end{center}
	\captionof{figure}{}
	\label{fig:xnyn}	
\end{figure}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/dtft.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/hn.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/hndef.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/ynconv.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/6.1.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/6.2.pdf}
	\caption{$Y(k)$}
\end{figure}
\item Compute
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/6.3.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/6.4.pdf}
...
\end{align*}
	...
	\end{lstlisting}
	\begin{figure}[!htb]
		\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/8.2.1.pdf}
		\caption{Plot of $H(e^{\j\omega})$}
		\label{fig:butter-imp}
	\end{figure}
	\begin{figure}[!htb]
		\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/8.2.2.pdf}
		\caption{Filter frequency response}
		\label{fig:butter-resp}
	\end{figure}
	\begin{figure}[!htb]
		\includegraphics[width=\columnwidth]{https://github.com/omkar30122001/Assign_1/blob/main/8.2.3.pdf}
		\caption{Plot of $y(n)$}
